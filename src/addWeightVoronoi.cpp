...
// // produce a additively weight Voronoi diagram
// Rcpp::List voronoiDiagram(const Rcpp::NumericVector &x, const Rcpp::NumericVector &y, const Rcpp::NumericVector &weights){
//
